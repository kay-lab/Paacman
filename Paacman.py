...
#Started on 1/9/2017 by Patrick Erickson. Uploaded to Github on 4/5/2017.

#Import important modules.
import re
#This allows FASTA .txt files to be read in numerical and alphabetical order by file name
numbers = re.compile(r'(\d+)')
import openpyxl #Needs to be installed
...
#This allows overlapping substrings to be counted correctly.
